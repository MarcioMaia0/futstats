...
Definir uso de campos calculados.

## Regra

Campos calculados podem existir por performance, mas a fonte da verdade deve ser documentada.

## Exemplos

- placar consolidado.
- total de gols do jogador.
- média de avaliação do árbitro.
