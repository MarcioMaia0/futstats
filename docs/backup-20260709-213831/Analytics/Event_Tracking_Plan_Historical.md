...
Rascunho historico preservado. A referencia oficial do assunto agora e `Event_Tracking_Spec.md`.

Define eventos analíticos de produto.

Exemplos: match_created, goal_added, card_shared, player_invited.
