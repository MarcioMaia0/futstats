...
Definir qualidade e confiabilidade dos dados.

## Regras

1. Dados mínimos são válidos.
2. Dados avançados aumentam precisão.
3. Relatórios devem indicar quando dependem de dados incompletos.
4. Duplicidades devem ser tratadas por fluxo de merge/reivindicação.
