---
title: Launch Snapshot Test Cases
status: Draft
...
# Launch Snapshot Test Cases

Casos de teste do recorte inicial de lançamento: criar time, criar partida, marcar gol, compartilhar resultado.
