...
Definir filosofia de planos.

## Regras

- Uso casual deve ter plano gratuito viável.
- Monetização não deve bloquear registro básico de jogo.
- Recursos avançados podem ser premium.
- Times organizados são público de conversão.
