...
3. A modalidade e herdada do time e nunca exige escolha no fluxo casual.
4. Estatisticas e rankings podem segmentar por modalidade.
...
- `match_attendance_responses`
  - se confirmou ou recusou presenca para jogo agendado;
- `scheduled_matches`
