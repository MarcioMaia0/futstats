...
- Deve aceitar jogo de ultima hora sem agendamento previo.
- Quando a partida nascer sem agendamento previo, o sistema deve incluir esse jogo na agenda do time por fluxo derivado.
...
- criar partida operacional sem agendamento previo;
- atualizar placar;
- registrar gols;
- finalizar partida;
