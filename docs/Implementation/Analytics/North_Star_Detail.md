...
Detalhar métrica norte.

## Proposta

Número de partidas registradas e compartilhadas por semana.

## Justificativa

Essa métrica captura o valor inicial do produto: registrar e compartilhar a experiência do jogo.

## Métricas de apoio

- Times ativos semanais.
- Cards compartilhados.
- Usuários que registraram gols.
- Conversão para elenco.
- Conversão para scout.
