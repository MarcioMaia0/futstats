---
title: Launch Snapshot Acceptance Tests
status: Review
...
# Launch Snapshot Acceptance Tests
...
Dado que existe uma partida, quando o usuário adiciona um gol, então o placar e a artilharia são atualizados.
