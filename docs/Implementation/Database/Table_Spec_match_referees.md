...
- `referee_person_id` (uuid, FK → `persons.id`, nullable) — árbitro ad-hoc identificado por pessoa
- `external` (boolean, default false)
- `created_at`

## Regras

- Aponta o árbitro da partida: profissional cadastrado (`referee_id`) ou pessoa ad-hoc (`referee_person_id`).
