---
title: ADR Casual First Product
status: Draft
version: 0.9.0
...
# ADR Casual First Product

## Contexto

Havia risco de posicionar o FUTSTATS como ferramenta analítica pesada.

## Decisão

Adotar estratégia casual-first: valor social e simples primeiro, inteligência depois.

## Consequências

- MVP mais leve;
- maior chance de adoção;
- recursos avançados precisam ser opcionais;
- comunicação para investidores deve refletir funil de evolução.
