...
# ADR Use Modular Docs

## Contexto

Documentos grandes estavam difíceis de manter.

## Decisão

Usar documentação modular por pastas e arquivos pequenos.
