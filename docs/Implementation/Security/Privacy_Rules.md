...
- Perfil pode ser público ou restrito.
- Estatísticas sensíveis podem ser privadas.
- Conteúdo social respeita visibilidade.
- Usuário controla preferências.
- Menores de idade exigem cuidado futuro.
- Dados históricos não devem ser apagados sem política clara.
