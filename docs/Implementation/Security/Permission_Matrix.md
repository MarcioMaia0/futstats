...
- Manager gerencia partidas.
- Coach acessa scout e relatórios.
- Player edita próprio perfil.
- Supporter consome conteúdo público.
- Admin atua em moderação e suporte.
