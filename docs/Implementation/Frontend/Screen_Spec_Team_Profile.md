---
title: Screen Spec Team Profile
status: Draft
version: 0.9.0
...
# Screen Spec Team Profile

## Objetivo

Especificar tela de perfil do time.
...
- Tema do time deve ser aplicado.
- Conteúdo público respeita privacidade.
