---
title: Screen Spec Match Report
status: Draft
version: 0.9.0
...
# Screen Spec Match Report

## Objetivo

Especificar tela de relatório de partida.
...
- Dados ausentes não devem gerar erro visual.
- Mostrar mensagem educativa quando métrica avançada não estiver disponível.
